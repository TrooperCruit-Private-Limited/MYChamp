...
{
    [AllowAnonymous] //This attribute allows unauthenticated users to access this controller’s actions.
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<int>> OnPostAsync(LoginModel login_Model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = _db.registerModel.FirstOrDefault(u=>u.EmailId == login_Model.Name
                 );
        ...
        internal async Task<ActionResult<int>> OnPostAsync(Pages.Authentication.LoginPageModel login_Model)
        {
